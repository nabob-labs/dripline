...
use crate::llm_analysis::db::{list_instructions, with_analysis_db};
use crate::llm_analysis::types::EvaluationContext;
...
impl PromptBuilder {
    ...
    fn get_user_instructions() -> Option<String> {
        with_analysis_db(|db| match list_instructions(db) {
            Ok(instructions) => {
