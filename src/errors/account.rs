//! DripLine account errors — signing in to dripline.io from the app.
//!
...
pub enum AccountError {
    ...
    #[error("not signed in to a DripLine account")]
    NotSignedIn,
    ...
    #[error("your DripLine session has ended. Sign in again from Settings.")]
    SessionEnded,
    ...
    #[error("unexpected response from dripline.io: {message}")]
    UnexpectedResponse { message: String },

    /// Local storage of the session failed.
    #[error("could not save the DripLine session: {message}")]
